...
gulp.task('watch', function(){
    gulp.watch(path.src.icon, gulp.series('iconfont:build'))
...
// Сброка полная
gulp.task('build:all', gulp.parallel('html:build','css:build','fonts:build','js:build','iconfont:build','img:build'));
